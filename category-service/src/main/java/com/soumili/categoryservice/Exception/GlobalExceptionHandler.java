...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponse> handleUserNotLoggedInException(UserNotLoggedInException e) {
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("User Not Logged In Yet!!"),HttpStatus.INTERNAL_SERVER_ERROR);
	}

	@ExceptionHandler(UserNotAllowedException.class)
	public ResponseEntity<ApiResponse> handleUserNotAllowedException(UserNotAllowedException e) {

		return new ResponseEntity<ApiResponse>( new ApiResponse("User Not allowed to Perform this operation!!"),HttpStatus.INTERNAL_SERVER_ERROR);
	}

	@ExceptionHandler(CategoryAlreadyExistsException.class)
	public ResponseEntity<ApiResponse> handleCategoryAlreadyExistsException(CategoryAlreadyExistsException e) {

		return new ResponseEntity<ApiResponse>(new ApiResponse("Category Already exists!!"),HttpStatus.INTERNAL_SERVER_ERROR);
	}
