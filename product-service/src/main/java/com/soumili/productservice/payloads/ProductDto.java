...
public class ProductDto {
	...
	public ProductDto(int product_id, @NotBlank(message = "This field cannot be empty") String product_name,
			...
			@Min(value = 1, message = "Stock Count must be greater or equal to 1") @Max(value = 999, message = "Product prices must be less than or equal to 999") Integer stock_count,
