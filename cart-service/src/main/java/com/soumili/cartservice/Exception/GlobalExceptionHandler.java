...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponse> handleProductNotAvailableExcepion(ProductNotAvailableException e) {

		return new ResponseEntity<ApiResponse>(new ApiResponse("Product is not available!!"),
				HttpStatus.INTERNAL_SERVER_ERROR);
	}

	@ExceptionHandler(ProductOutOfStockException.class)

	public ResponseEntity<ApiResponse> handleProductOutOfStockException(ProductOutOfStockException e) {

		return new  ResponseEntity<ApiResponse>(new ApiResponse("Product is out of Stock!!"),HttpStatus.INTERNAL_SERVER_ERROR);
	}
